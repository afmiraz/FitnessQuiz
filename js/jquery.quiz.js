;(function($, window, document, undefined) {
  ...
  $.quiz.defaultOptions = {
    ...
    resultsFormat: ' <div id="email-subs"><b>Enter your email for results</b> <br><input class="uk-input uk-form-large uk-border-rounded" name="name" type="text" required=""><input class="uk-button uk-button-primary uk-button-large uk-width-1-1 uk-border-rounded send-btn" type="submit" value="Send"></div>',
    gameOverScreen: '#quiz-gameover-screen',
    nextButtonText: 'Next',
    finishButtonText: 'Finish',
    restartButtonText: 'Or Restart'
